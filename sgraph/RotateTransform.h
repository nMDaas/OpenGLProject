    ...
    class RotateTransform: public TransformNode {
        protected:
            ...
            ParentSGNode *copyNode() {
                return new RotateTransform(angleInRadians,axis[0],axis[1],axis[2],name,scenegraph,lights);
            }

        public:
            RotateTransform(float angleInRadians,float ax,float ay,float az,const string& name,sgraph::IScenegraph *graph, vector<util::Light> i_lights) 
