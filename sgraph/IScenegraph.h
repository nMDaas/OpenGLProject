 ...
 */
   ...
   /**
     ...
     */
      ...
      virtual void setTextureObjects(map<string, util::TextureImage *> textureObjects)=0;
      virtual vector<string> getTextureNames()=0;
      virtual util::TextureImage* getTextureObject(const string& name)=0;
    };
}
